...
class ConjugationRule:
  ...
  sd_paradigm: str
  sd_tense: str = None
  iprob: float = 1 # number in range [0; 1]; probability of the conjugation card generation for irregular verbs
  ...
  def produce_note_modifications(self, sd_conjugation, note_tags):
    ...
    for conj in sd_conjugation:
      if self._matches(conj):
        ...
        prob = self.iprob if conj.get('isIrregular', False) else self.prob
...
RULES = [
      ...
      ConjugationRule(note_field="PerfectYo",                  prob=0.15, iprob=0.25, sd_pronoun="yo",               sd_paradigm="presentPerfect"),
      ConjugationRule(note_field="PerfectTu",                  prob=0.15, iprob=0.25, sd_pronoun="tú",               sd_paradigm="presentPerfect"),
      ConjugationRule(note_field="PerfectEl",                  prob=0.15, iprob=0.25, sd_pronoun="él/ella/Ud.",      sd_paradigm="presentPerfect"),
      ConjugationRule(note_field="PerfectNosotros",            prob=0.15, iprob=0.25, sd_pronoun="nosotros",         sd_paradigm="presentPerfect"),
      ConjugationRule(note_field="PerfectVosotros",            prob=0.15, iprob=0.25, sd_pronoun="vosotros",         sd_paradigm="presentPerfect"),
      ConjugationRule(note_field="PerfectEllos",               prob=0.15, iprob=0.25, sd_pronoun="ellos/ellas/Uds.", sd_paradigm="presentPerfect"),

      ConjugationRule(note_field="ProgressiveYo",              prob=0.15, iprob=0.25, sd_pronoun="yo",               sd_paradigm="presentContinuous"),
      ConjugationRule(note_field="ProgressiveTu",              prob=0.15, iprob=0.25, sd_pronoun="tú",               sd_paradigm="presentContinuous"),
      ConjugationRule(note_field="ProgressiveEl",              prob=0.15, iprob=0.25, sd_pronoun="él/ella/Ud.",      sd_paradigm="presentContinuous"),
